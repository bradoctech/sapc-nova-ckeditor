    ...
    >
      <div v-if="field.showSelects" class="flex mb-3">
        <div class="w-1/4 px-1">
          ...
          <button @click="addVariavelContaGoverno()" class="mt-2 w-full shadow relative bg-primary-500 hover:bg-primary-400 text-white dark:text-gray-900 cursor-pointer rounded text-sm font-bold focus:outline-none focus:ring ring-primary-200 dark:ring-gray-600 inline-flex items-center justify-center h-9 px-3 shadow relative bg-primary-500 hover:bg-primary-400 text-white dark:text-gray-900" type="button">
        ...
        <div class="w-1/4 px-1">
          ...
          <button @click="addVariavelContaGestao()" class="mt-2 w-full shadow relative bg-primary-500 hover:bg-primary-400 text-white dark:text-gray-900 cursor-pointer rounded text-sm font-bold focus:outline-none focus:ring ring-primary-200 dark:ring-gray-600 inline-flex items-center justify-center h-9 px-3 shadow relative bg-primary-500 hover:bg-primary-400 text-white dark:text-gray-900" type="button">
    ...
    addAnalise() {
      ...
      if (editor) {
        editor.model.change( writer => {
          ...
          const viewFragment = editor.data.processor.toView( '$_al{'+this.analiseSelecionada+'}' );
          const modelFragment = editor.data.toModel( viewFragment );
          editor.model.insertContent(modelFragment, insertPosition );
        } );
      }
